...
XCOPY /Y/D/R "%~dp0..\..\..\..\Rhetos\Source\Rhetos.Dom.Interfaces\bin\Debug\Rhetos.Dom.Interfaces.???" "%~dp0" || EXIT /B 1
...
XCOPY /Y/D/R "%~dp0..\..\..\..\Rhetos\Source\Rhetos.XmlSerialization\bin\Debug\Rhetos.XmlSerialization.???" "%~dp0" || EXIT /B 1
...
XCOPY /Y/D/R "%~dp0..\..\..\..\Rhetos\CommonConcepts\Plugins\Rhetos.Dom.DefaultConcepts\bin\Debug\Rhetos.Dom.DefaultConcepts.???" "%~dp0" || EXIT /B 1
