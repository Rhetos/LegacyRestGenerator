...
@CALL :SafeCopy ..\..\..\..\Rhetos\Source\Rhetos.Dom.Interfaces\bin\Debug\Rhetos.Dom.Interfaces.??? || GOTO Error1
...
@CALL :SafeCopy ..\..\..\..\Rhetos\Source\Rhetos.XmlSerialization\bin\Debug\Rhetos.XmlSerialization.??? || GOTO Error1
