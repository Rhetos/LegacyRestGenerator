...
namespace Rhetos.LegacyRestGenerator.DefaultConcepts
{
    ...
    [ExportMetadata(MefProvider.Implements, typeof(QueryFilterInfo))]
    public class QueryFilterCodeGenerator : ILegacyRestGeneratorPlugin
    {
        private static string CodeSnippet(QueryFilterInfo info)
        {
...
@"Tuple.Create(""{0}"", typeof({1})),
        ...
        {
            var info = (QueryFilterInfo)conceptInfo;
