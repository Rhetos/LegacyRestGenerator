...
namespace Rhetos.LegacyRestGenerator
{
    ...
    /// ILegacyRestGeneratorPlugin are code generator which transform specific IConceptInfo into Rest definition classes.
    /// </summary>
    [Export(typeof(Module))]
    public class LegacyRestGeneratorModuleConfiguration : Module
    {
